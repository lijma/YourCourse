		...
		<view :style="club_apply_enabled ? 'display: block' : 'display: none'">
			<view style="padding: 10px;">
				<uni-forms ref="form" :modelValue="formData" :rules="rules">
					<uni-forms-item required label="名称" name="siteName">
						<uni-easyinput type="text" v-model="formData.siteName" placeholder="..." />
					</uni-forms-item>
					<uni-forms-item required label="Email" name="email">
						<uni-easyinput type="text" v-model="formData.email" placeholder="..." />
					</uni-forms-item>
					<uni-forms-item label="Location" name="city">
						<uni-easyinput type="text" v-model="formData.city" placeholder="..." />
					</uni-forms-item>
					<uni-forms-item required label="首页照" name="logo">
						<file-uploader v-model="formData.logo"></file-uploader>
					</uni-forms-item>
					<uni-forms-item label="详细描述" name="detail">
					</uni-forms-item>
					<editor id="editor" class="ql-container" @input="input" placeholder="点击输入..." @ready="onEditorReady">
					</editor>
			
				</uni-forms>
				<uni-popup ref="message" type="message">
					<uni-popup-message type="success" message="申请成功,请联系Community Owner审核"></uni-popup-message>
				</uni-popup>
